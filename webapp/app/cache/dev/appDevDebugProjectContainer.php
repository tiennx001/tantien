...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'product.color.constraint' => 'getProduct_Color_ConstraintService',
            'product.update' => 'getProduct_UpdateService',
            ...
            'service.helper' => 'getService_HelperService',
            ...
            'twig.get.image.extension' => 'getTwig_Get_Image_ExtensionService',
    ...
    {
        $instance = new \AppBundle\Admin\ProductAdmin('admin.product', 'AppBundle\\Entity\\Product', 'AppBundle:CRUD');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $c->addEventListener(array(0 => 'preUpdate'), $this->get('product.update'));
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'yourhome_v1', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $d->setEntityNamespaces(array('ApplicationSonataUserBundle' => 'Application\\Sonata\\UserBundle\\Entity', 'SonataUserBundle' => 'Sonata\\UserBundle\\Entity', 'FOSUserBundle' => 'FOS\\UserBundle\\Entity', 'AppBundle' => 'AppBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_515bbee78234fe7df5907a7fe1e29478f47daaeff3afa868893bb33969db61f0');
    ...
    {
        return $this->services['knp_paginator.subscriber.sliding_pagination'] = new \Knp\Bundle\PaginatorBundle\Subscriber\SlidingPaginationSubscriber(array('defaultPaginationTemplate' => 'FrontBundle:Default:_paging.html.twig', 'defaultSortableTemplate' => '@KnpPaginator/Pagination/sortable_link.html.twig', 'defaultFiltrationTemplate' => '@KnpPaginator/Pagination/filtration.html.twig', 'defaultPageRange' => 5));
    }
    ...
    /**
     * Gets the 'product.color.constraint' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Validator\Constraints\ConstraintColorValidator A AppBundle\Validator\Constraints\ConstraintColorValidator instance
     */
    protected function getProduct_Color_ConstraintService()
    {
        return $this->services['product.color.constraint'] = new \AppBundle\Validator\Constraints\ConstraintColorValidator($this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the 'product.update' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\EventListener\UpdateEntityListener A AppBundle\EventListener\UpdateEntityListener instance
     */
    protected function getProduct_UpdateService()
    {
        return $this->services['product.update'] = new \AppBundle\EventListener\UpdateEntityListener($this->targetDirs[2]);
    }
    ...
    /**
     * Gets the 'service.helper' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Service\HelperService A AppBundle\Service\HelperService instance
     */
    protected function getService_HelperService()
    {
        return $this->services['service.helper'] = new \AppBundle\Service\HelperService();
    }
    ...
    {
        $a = new \Predis\Profile\RedisVersion300();
        ...
        return $this->services['snc_redis.default'] = new \Predis\Client(new \Predis\Connection\Parameters(array('read_write_timeout' => NULL, 'iterable_multibulk' => false, 'profile' => 'default', 'prefix' => NULL, 'service' => NULL, 'async_connect' => false, 'timeout' => 5, 'persistent' => false, 'exceptions' => true, 'logging' => true, 'alias' => 'default', 'scheme' => 'tcp', 'host' => '150.95.105.109', 'port' => 6379, 'password' => NULL, 'weight' => NULL)), new \Predis\Configuration\Options(array('read_write_timeout' => NULL, 'iterable_multibulk' => false, 'profile' => $a, 'prefix' => NULL, 'service' => NULL, 'async_connect' => false, 'timeout' => 5, 'persistent' => false, 'exceptions' => true, 'connections' => $b)));
    }
    ...
    {
        $this->services['sonata.admin.pool'] = $instance = new \Sonata\AdminBundle\Admin\Pool($this, 'My Shop', 'bundles/app/img/yh.png', array('html5_validate' => true, 'sort_admins' => false, 'confirm_exit' => true, 'use_select2' => true, 'use_icheck' => true, 'use_bootlint' => false, 'use_stickyforms' => true, 'pager_links' => NULL, 'form_type' => 'standard', 'dropdown_number_groups_per_colums' => 2, 'title_mode' => 'both', 'lock_protection' => false, 'enable_jms_di_extra_autoregistration' => true, 'javascripts' => array(0 => 'bundles/sonatacore/vendor/jquery/dist/jquery.min.js', 1 => 'bundles/sonataadmin/vendor/jquery.scrollTo/jquery.scrollTo.min.js', 2 => 'bundles/sonatacore/vendor/moment/min/moment.min.js', 3 => 'bundles/sonataadmin/vendor/jqueryui/ui/minified/jquery-ui.min.js', 4 => 'bundles/sonataadmin/vendor/jqueryui/ui/minified/i18n/jquery-ui-i18n.min.js', 5 => 'bundles/sonatacore/vendor/bootstrap/dist/js/bootstrap.min.js', 6 => 'bundles/sonatacore/vendor/eonasdan-bootstrap-datetimepicker/build/js/bootstrap-datetimepicker.min.js', 7 => 'bundles/sonataadmin/vendor/jquery-form/jquery.form.js', 8 => 'bundles/sonataadmin/jquery/jquery.confirmExit.js', 9 => 'bundles/sonataadmin/vendor/x-editable/dist/bootstrap3-editable/js/bootstrap-editable.min.js', 10 => 'bundles/sonatacore/vendor/select2/select2.min.js', 11 => 'bundles/sonataadmin/vendor/admin-lte/dist/js/app.min.js', 12 => 'bundles/sonataadmin/vendor/iCheck/icheck.min.js', 13 => 'bundles/sonataadmin/vendor/slimScroll/jquery.slimscroll.min.js', 14 => 'bundles/sonataadmin/vendor/waypoints/lib/jquery.waypoints.min.js', 15 => 'bundles/sonataadmin/vendor/waypoints/lib/shortcuts/sticky.min.js', 16 => 'bundles/sonataadmin/vendor/readmore-js/readmore.min.js', 17 => 'bundles/sonataadmin/vendor/masonry/dist/masonry.pkgd.min.js', 18 => 'bundles/sonataadmin/Admin.js', 19 => 'bundles/sonataadmin/treeview.js'), 'stylesheets' => array(0 => 'bundles/sonatacore/vendor/bootstrap/dist/css/bootstrap.min.css', 1 => 'bundles/sonatacore/vendor/components-font-awesome/css/font-awesome.min.css', 2 => 'bundles/sonatacore/vendor/ionicons/css/ionicons.min.css', 3 => 'bundles/sonataadmin/vendor/admin-lte/dist/css/AdminLTE.min.css', 4 => 'bundles/sonataadmin/vendor/admin-lte/dist/css/skins/skin-black.min.css', 5 => 'bundles/sonataadmin/vendor/iCheck/skins/square/blue.css', 6 => 'bundles/sonatacore/vendor/eonasdan-bootstrap-datetimepicker/build/css/bootstrap-datetimepicker.min.css', 7 => 'bundles/sonataadmin/vendor/jqueryui/themes/base/jquery-ui.css', 8 => 'bundles/sonatacore/vendor/select2/select2.css', 9 => 'bundles/sonatacore/vendor/select2-bootstrap-css/select2-bootstrap.min.css', 10 => 'bundles/sonataadmin/vendor/x-editable/dist/bootstrap3-editable/css/bootstrap-editable.css', 11 => 'bundles/sonataadmin/css/styles.css', 12 => 'bundles/sonataadmin/css/layout.css', 13 => 'bundles/sonataadmin/css/tree.css')), $this->get('property_accessor'));
        ...
        $instance->setAdminServiceIds(array(0 => 'admin.product', 1 => 'admin.category', 2 => 'sonata.user.admin.user', 3 => 'sonata.user.admin.group'));
        $instance->setAdminGroups(array('admin.group.content' => array('label' => 'Nội dung', 'label_catalogue' => 'AppBundle', 'items' => array(0 => array('admin' => 'admin.product', 'label' => '', 'route' => '', 'route_params' => array(), 'route_absolute' => true, 'roles' => array()), 1 => array('admin' => 'admin.category', 'label' => '', 'route' => '', 'route_params' => array(), 'route_absolute' => true, 'roles' => array())), 'icon' => '<i class="fa fa-folder"></i>', 'on_top' => false, 'keep_open' => false, 'item_adds' => array(), 'roles' => array()), 'admin.group.user' => array('label' => 'Người dùng', 'icon' => '<i class="fa fa-users"></i>', 'label_catalogue' => 'AppBundle', 'items' => array(0 => array('admin' => 'sonata.user.admin.user', 'label' => '', 'route' => '', 'route_params' => array(), 'route_absolute' => true, 'roles' => array()), 1 => array('admin' => 'sonata.user.admin.group', 'label' => '', 'route' => '', 'route_params' => array(), 'route_absolute' => true, 'roles' => array())), 'on_top' => false, 'keep_open' => false, 'item_adds' => array(), 'roles' => array())));
        $instance->setAdminClasses(array('AppBundle\\Entity\\Product' => array(0 => 'admin.product'), 'AppBundle\\Entity\\Category' => array(0 => 'admin.category'), 'Application\\Sonata\\UserBundle\\Entity\\User' => array(0 => 'sonata.user.admin.user'), 'Application\\Sonata\\UserBundle\\Entity\\Group' => array(0 => 'sonata.user.admin.group')));
    ...
    {
        return $this->services['sonata.admin.route_loader'] = new \Sonata\AdminBundle\Route\AdminPoolLoader($this->get('sonata.admin.pool'), array(0 => 'admin.product', 1 => 'admin.category', 2 => 'sonata.user.admin.user', 3 => 'sonata.user.admin.group'), $this);
    }
    ...
    protected function getSonata_EasyExtends_Doctrine_MapperService()
    {
        ...
        $instance->addAssociation('Application\\Sonata\\UserBundle\\Entity\\User', 'mapManyToMany', array(0 => array('fieldName' => 'groups', 'targetEntity' => 'Application\\Sonata\\UserBundle\\Entity\\Group', 'cascade' => array(), 'joinTable' => array('name' => 'fos_user_group_ref', 'joinColumns' => array(0 => array('name' => 'user_id', 'referencedColumnName' => 'id', 'onDelete' => 'CASCADE')), 'inverseJoinColumns' => array(0 => array('name' => 'group_id', 'referencedColumnName' => 'id', 'onDelete' => 'CASCADE'))))));
    ...
    {
        return $this->services['sonata.user.profile.menu_builder'] = new \Sonata\UserBundle\Menu\ProfileMenuBuilder($this->get('knp_menu.factory'), $this->get('translator'), array(0 => array('route' => 'sonata_user_profile_show', 'label' => 'sonata_profile_title', 'domain' => 'SonataUserBundle', 'route_parameters' => array()), 1 => array('route' => 'sonata_user_profile_edit', 'label' => 'link_edit_profile', 'domain' => 'SonataUserBundle', 'route_parameters' => array()), 2 => array('route' => 'sonata_customer_addresses', 'label' => 'link_list_addresses', 'domain' => 'SonataCustomerBundle', 'route_parameters' => array()), 3 => array('route' => 'sonata_user_profile_edit_authentication', 'label' => 'link_edit_authentication', 'domain' => 'SonataUserBundle', 'route_parameters' => array()), 4 => array('route' => 'sonata_order_index', 'label' => 'order_list', 'domain' => 'SonataOrderBundle', 'route_parameters' => array())), $this->get('debug.event_dispatcher'));
    }
    ...
    protected function getTwigService()
    {
        ...
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'form_themes' => array(0 => 'form_div_layout.html.twig', 1 => 'SonataCoreBundle:Form:datepicker.html.twig', 2 => 'AppBundle:Form:fields.html.twig'), 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape' => 'name', 'cache' => (__DIR__.'/twig'), 'charset' => 'UTF-8', 'paths' => array(), 'date' => array('format' => 'F j, Y H:i', 'interval_format' => '%d days', 'timezone' => NULL), 'number_format' => array('decimals' => 0, 'decimal_point' => '.', 'thousands_separator' => ',')));

        $instance->addExtension($this->get('twig.get.image.extension'));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\FormExtension(new \Symfony\Bridge\Twig\Form\TwigRenderer(new \Symfony\Bridge\Twig\Form\TwigRendererEngine(array(0 => 'form_div_layout.html.twig', 1 => 'SonataCoreBundle:Form:datepicker.html.twig', 2 => 'AppBundle:Form:fields.html.twig', 3 => 'SonataUserBundle:Form:form_admin_fields.html.twig')), $this->get('security.csrf.token_manager', ContainerInterface::NULL_ON_INVALID_REFERENCE))));
    ...
    /**
     * Gets the 'twig.get.image.extension' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \FrontBundle\Twig\TwigExtension A FrontBundle\Twig\TwigExtension instance
     */
    protected function getTwig_Get_Image_ExtensionService()
    {
        return $this->services['twig.get.image.extension'] = new \FrontBundle\Twig\TwigExtension();
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('3e06f89fc74ffec67b517ca11a1e1fc84661abdc');
    }
    ...
    {
        return $this->services['validator.validator_factory'] = new \Symfony\Bundle\FrameworkBundle\Validator\ConstraintValidatorFactory($this, array('ConstraintColor' => 'product.color.constraint', 'AppBundle\\Validator\\Constraints\\ConstraintColorValidator' => 'product.color.constraint', 'validator.expression' => 'validator.expression', 'Symfony\\Component\\Validator\\Constraints\\ExpressionValidator' => 'validator.expression', 'Symfony\\Component\\Validator\\Constraints\\EmailValidator' => 'validator.email', 'doctrine.orm.validator.unique' => 'doctrine.orm.validator.unique', 'Symfony\\Bridge\\Doctrine\\Validator\\Constraints\\UniqueEntityValidator' => 'doctrine.orm.validator.unique', 'security.validator.user_password' => 'security.validator.user_password', 'Symfony\\Component\\Security\\Core\\Validator\\Constraints\\UserPasswordValidator' => 'security.validator.user_password', 'sonata.core.validator.inline' => 'sonata.core.validator.inline', 'Sonata\\CoreBundle\\Validator\\InlineValidator' => 'sonata.admin.validator.inline', 'sonata.admin.validator.inline' => 'sonata.admin.validator.inline'));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'secret' => '3e06f89fc74ffec67b517ca11a1e1fc84661abdc',
            'locale' => 'en',
            ...
            'kernel.secret' => '3e06f89fc74ffec67b517ca11a1e1fc84661abdc',
            ...
            'knp_paginator.template.pagination' => 'FrontBundle:Default:_paging.html.twig',
