            ...
            if (0 === strpos($pathinfo, '/admin/app')) {
                if (0 === strpos($pathinfo, '/admin/app/product')) {
                    ...
                    if ($pathinfo === '/admin/app/product/list') {
                        return array (  '_controller' => 'AppBundle\\Controller\\CRUDController::listAction',  '_sonata_admin' => 'admin.product',  '_sonata_name' => 'admin_app_product_list',  '_route' => 'admin_app_product_list',);
                    }

                    // admin_app_product_create
                    if ($pathinfo === '/admin/app/product/create') {
                        return array (  '_controller' => 'AppBundle\\Controller\\CRUDController::createAction',  '_sonata_admin' => 'admin.product',  '_sonata_name' => 'admin_app_product_create',  '_route' => 'admin_app_product_create',);
                    }

                    // admin_app_product_batch
                    if ($pathinfo === '/admin/app/product/batch') {
                        return array (  '_controller' => 'AppBundle\\Controller\\CRUDController::batchAction',  '_sonata_admin' => 'admin.product',  '_sonata_name' => 'admin_app_product_batch',  '_route' => 'admin_app_product_batch',);
                    }

                    // admin_app_product_edit
                    if (preg_match('#^/admin/app/product/(?P<id>[^/]++)/edit$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_product_edit')), array (  '_controller' => 'AppBundle\\Controller\\CRUDController::editAction',  '_sonata_admin' => 'admin.product',  '_sonata_name' => 'admin_app_product_edit',));
                    }

                    // admin_app_product_delete
                    if (preg_match('#^/admin/app/product/(?P<id>[^/]++)/delete$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_product_delete')), array (  '_controller' => 'AppBundle\\Controller\\CRUDController::deleteAction',  '_sonata_admin' => 'admin.product',  '_sonata_name' => 'admin_app_product_delete',));
                    }

                    // admin_app_product_show
                    if (preg_match('#^/admin/app/product/(?P<id>[^/]++)/show$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_product_show')), array (  '_controller' => 'AppBundle\\Controller\\CRUDController::showAction',  '_sonata_admin' => 'admin.product',  '_sonata_name' => 'admin_app_product_show',));
                    }

                    // admin_app_product_export
                    if ($pathinfo === '/admin/app/product/export') {
                        return array (  '_controller' => 'AppBundle\\Controller\\CRUDController::exportAction',  '_sonata_admin' => 'admin.product',  '_sonata_name' => 'admin_app_product_export',  '_route' => 'admin_app_product_export',);
                    }
