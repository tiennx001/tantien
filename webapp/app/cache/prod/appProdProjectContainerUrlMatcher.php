...
class appProdProjectContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (rtrim($pathinfo, '/') === '') {
            ...
            return array (  '_controller' => 'FrontBundle\\Controller\\HomeController::indexAction',  '_route' => 'homepage',);
        }

        // product_detail
        if (0 === strpos($pathinfo, '/san-pham') && preg_match('#^/san\\-pham/(?P<slug>[^/]++)$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'product_detail')), array (  '_controller' => 'FrontBundle\\Controller\\DetailController::indexAction',));
        }

        // search
        if (0 === strpos($pathinfo, '/tim-kiem') && preg_match('#^/tim\\-kiem(?:/(?P<page>[^/]++))?$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'search')), array (  '_controller' => 'FrontBundle\\Controller\\SearchController::indexAction',  'page' => 1,));
        }

        // category
        if (0 === strpos($pathinfo, '/danh-muc') && preg_match('#^/danh\\-muc/(?P<cateSlug>[^/]++)(?:/(?P<page>[^/]++))?$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'category')), array (  '_controller' => 'FrontBundle\\Controller\\CategoryController::indexAction',  'page' => 1,));
        }
        ...
        if (0 === strpos($pathinfo, '/admin')) {
            ...
            if (0 === strpos($pathinfo, '/admin/app')) {
                if (0 === strpos($pathinfo, '/admin/app/product')) {
                    // admin_app_product_list
                    if ($pathinfo === '/admin/app/product/list') {
                        return array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::listAction',  '_sonata_admin' => 'admin.product',  '_sonata_name' => 'admin_app_product_list',  '_route' => 'admin_app_product_list',);
                    }

                    // admin_app_product_create
                    if ($pathinfo === '/admin/app/product/create') {
                        return array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::createAction',  '_sonata_admin' => 'admin.product',  '_sonata_name' => 'admin_app_product_create',  '_route' => 'admin_app_product_create',);
                    }

                    // admin_app_product_batch
                    if ($pathinfo === '/admin/app/product/batch') {
                        return array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::batchAction',  '_sonata_admin' => 'admin.product',  '_sonata_name' => 'admin_app_product_batch',  '_route' => 'admin_app_product_batch',);
                    }

                    // admin_app_product_edit
                    if (preg_match('#^/admin/app/product/(?P<id>[^/]++)/edit$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_product_edit')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::editAction',  '_sonata_admin' => 'admin.product',  '_sonata_name' => 'admin_app_product_edit',));
                    }

                    // admin_app_product_delete
                    if (preg_match('#^/admin/app/product/(?P<id>[^/]++)/delete$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_product_delete')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::deleteAction',  '_sonata_admin' => 'admin.product',  '_sonata_name' => 'admin_app_product_delete',));
                    }

                    // admin_app_product_show
                    if (preg_match('#^/admin/app/product/(?P<id>[^/]++)/show$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_product_show')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::showAction',  '_sonata_admin' => 'admin.product',  '_sonata_name' => 'admin_app_product_show',));
                    }

                    // admin_app_product_export
                    if ($pathinfo === '/admin/app/product/export') {
                        return array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::exportAction',  '_sonata_admin' => 'admin.product',  '_sonata_name' => 'admin_app_product_export',  '_route' => 'admin_app_product_export',);
                    }
        ...
        if (0 === strpos($pathinfo, '/product')) {
            ...
            if ($pathinfo === '/product/upload-multiple-files') {
                return array (  '_controller' => 'AppBundle\\Controller\\CRUDController::uploadMultipleFileAction',  '_sonata_admin' => '',  '_route' => 'upload_multiple_file',);
            }

            // delete_uploaded_file
            if ($pathinfo === '/product/delete-uploaded-file') {
                return array (  '_controller' => 'AppBundle\\Controller\\CRUDController::deleteUploadedFileAction',  '_sonata_admin' => '',  '_route' => 'delete_uploaded_file',);
            }
