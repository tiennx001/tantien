...
class DoctrineParamConverterTest extends \PHPUnit_Framework_TestCase
{
     ...
     * @expectedExceptionMessage Model method "Sensio\Bundle\FrameworkExtraBundle\Tests\Request\ParamConverter\TestUserRepository::findByFullName" requires that you provide a value for the "$lastName" argument.
     */
